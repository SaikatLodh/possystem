  ...
  return (
    <div className="min-h-screen bg-[#0e0e0e] flex items-center justify-center px-4 overflow-hidden relative">
      ...
      >
        ...
        <div className="flex-1 text-center md:text-left order-2 md:order-1">
          ...
          >
            ...
            <p className="text-[#adaaaa] text-lg mb-10 leading-relaxed max-w-md mx-auto md:mx-0">
              It seems the page you are looking for has been cleared from our menu. Don't worry, our chef recommends heading back to home.
            </p>
        ...
        <motion.div 
          className="flex-1 relative group order-1 md:order-2"
          animate={{ 
            y: [0, -10, 0],
          }}
          transition={{ 
