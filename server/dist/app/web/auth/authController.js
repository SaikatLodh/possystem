...
import { forgotrestpasswordValidation, forgotsendemailValidation, loginValidation, registerValidation, sendOtpValidation, validateOtpValidation, } from "../../helpers/validator/auth/authValidation.js";
import bcrypt from "bcryptjs";
import crypto from "crypto";
import jwt from "jsonwebtoken";
import Otp from "../../models/otpModel.js";
import User from "../../models/userModel.js";
import generateAccessAndRefreshToken from "../../config/generatedToken.js";
...
`,
    ...
    async register(fullname, email, password, number) {
        try {
    ...
    async logIn(password, email, remember) {
        try {
            ...
            if (comparePassword) {
                const tokens = await generateAccessAndRefreshToken(checkUser.id);
...
<body style="font-family: Arial, sans-serif; background-color: #f4f4f4; margin: 0; padding: 0;">
    ...
    async forgotPassword(newPassword, confirmPassword, token) {
        try {
            if (!token) {
